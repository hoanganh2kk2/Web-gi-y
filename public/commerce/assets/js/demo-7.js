...
(function($) {
    ...
    //
    //     var p_html = '<li>'+
    //                     '<a href="javascript:void(0)" class="sidecart_pro_img"><img src="'+ img_url +'" alt="product"></a>'+
    ...
    $("#ec-spe-count-1").countdowntimer({
        ...
        dateAndTime : "2023/03/06 12:00:00",
        labelsFormat : true,
        displayFormat : "DHMS"
    });
...
/*--------------------- Trend Product Slider -------------------------------- */    
    ...
    /*----------------------------- Recent auto popup -----------------------------------*/
    setInterval(function () { $(".recent-purchase").stop().slideToggle('slow'); }, 50000);
